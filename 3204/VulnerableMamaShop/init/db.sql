...
INSERT INTO `users` VALUES (1,'Ming Hua','Tan','S9830887T','flagishere@mytestinternet.com.sg','secretagent0'),(2,'Kevin Boon Zeng','Lau','S8911009K','boon.zeng@newinternettest.sg','hiddenvalue-0'),(3,'Bean Hock','Quek','T0377668Z','bhq10@bht-int15.com.sg','password0'),(4,'Raymond ','Ng','S7769118C','raymond.ng@itesting.com.sg','test1234'),(5,'Zhi Wei','Tang','T1634009D','zwei-pu@test.network.sg','P@ssw0rd'),(6,'Betty Pu hong','Cheng','S8497001B','bty@h0menet.sg','b@tty-0987');
