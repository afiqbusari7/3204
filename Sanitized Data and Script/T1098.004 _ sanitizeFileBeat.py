...
# read file
data = pd.read_csv(r'D:\Documents\SIT Stuff\Y3T1\3204\Cleaning\T1098.004 _ Filebeat _ raw _ Grp12.csv')
...
#save file
data.to_csv(r'D:\Documents\SIT Stuff\Y3T1\3204\Cleaning\T1098.004 _ Filebeat _ clean _ Grp12.csv',index=False)
