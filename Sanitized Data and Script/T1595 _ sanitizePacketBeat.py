...
# read file
data = pd.read_csv(r'D:\Documents\SIT Stuff\Y3T1\3204\Cleaning\T1595 _ Packetbeat _ raw _ Grp12.csv', low_memory=False)
...
#save file
data.to_csv(r'D:\Documents\SIT Stuff\Y3T1\3204\Cleaning\T1595 _ Packetbeat _ clean _ Grp12.csv',index=False)
